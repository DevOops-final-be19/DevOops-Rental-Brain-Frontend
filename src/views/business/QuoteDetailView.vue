<template>
  <div class="page-container" v-loading="loading">
    ...
    <el-card shadow="never" class="detail-card">
      ...
      <el-descriptions :column="2" border size="large">
        ...
        <el-descriptions-item label="연락처">
          <a v-if="quote.customerCallNum" :href="`tel:${quote.customerCallNum}`">
        ...
        <el-descriptions-item label="이메일">
          <a v-if="quote.customerEmail" :href="`mailto:${quote.customerEmail}`">
            {{ quote.customerEmail }}
          </a>
          <span v-else>-</span>
        </el-descriptions-item>
      ...
      <div class="action-footer mt-4">
        <div class="button-group-right">
          <!-- 삭제 -->
          <el-tooltip v-if="!canModifyQuote" content="견적 처리 권한이 없습니다" placement="top">
            <span>
          ...
          <el-button v-else type="danger" plain @click="handleDelete">
            삭제
          </el-button>
    ...
    <QuoteCreateModal v-if="editModalVisible" v-model="editModalVisible" :edit-data="quote" @refresh="fetchData" />
